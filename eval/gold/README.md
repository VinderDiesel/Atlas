...
| 目录 | 编号段 | 场景 | 语义模型 | 状态 |
|---|---|---|---|---|
| `finance/` | gold-101 ~ 1xx | **金融分析（主场景）**：TPC-DI + FIBO 概念标注（ADR-0006/0007） | `atlas_finance_analytics` | 70 条全锚定（62 中文 + 8 英文，快照 1e5d35b） |
| `retail/` | gold-001 ~ 0xx | 零售分析（TPC-DS SF0.1，2026-09-04 转正为第二主评测域） | `atlas_retail_analytics` | 19 条全锚定（14 中文含 1 歧义 + 5 英文，快照 1e5d35b） |
...
> 推翻后零售段样本已全量锚定（19 条，双语分节），终验报告 `eval/reports/9749fc5.json`。
...
- 目标：50 条（含约 5 条歧义问句）；主域为金融段（101~150），零售为第二主评测域
  （2026-09-04 转正，见上文裁定推翻记录）
- 当前：89 条（零售 19 = 中文 14 + 英文 5、金融 70 = 中文 62 + 英文 8；歧义 6 条：零售 gold-047，金融 gold-104/121/122/148/155）——50 条目标已达成后按评测需要扩张（2026-09-03 filter 能力批次、2026-09-04 派生指标补洞批次、2026-09-04 零售段转正批次、2026-09-05 双语样本批次、2026-09-05 P7 收口批次）；2026-09-05 起样本按域分目录存储（本 README「目录结构与编号约定」节）
