...
| `retail/` | gold-001 ~ 0xx | 零售分析（TPC-DS SF0.1，2026-09-04 转正为第二主评测域） | `atlas_retail_analytics` | 14 条（12 可解析已落库，锚定随 P5 快照 dc4f350） |
