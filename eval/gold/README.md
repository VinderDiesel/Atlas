...
- 当前：89 条（零售 19 = 中文 14 + 英文 5、金融 70 = 中文 62 + 英文 8；歧义 6 条：零售 gold-047，金融 gold-104/121/122/148/155）——50 条目标已达成后按评测需要扩张（2026-09-03 filter 能力批次、2026-09-04 派生指标补洞批次、2026-09-04 零售段转正批次、2026-09-05 双语样本批次）；2026-09-05 起样本按域分目录存储（本 README「目录结构与编号约定」节）
